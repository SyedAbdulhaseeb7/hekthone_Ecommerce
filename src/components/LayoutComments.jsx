...
const Comment = () => {
  return (
    <div className=" p-6 rounded-lg ">
      <h2 className="font-bold text-xl lg:text-2xl text-gray-100 mb-6">
        Comments - 03
      </h2>
      <div className="space-y-6">
        ...
        <div className="flex space-x-4">
          ...
          />
          <div>
            <h3 className="text-lg flex gap-3 font-semibold text-gray-100">
              Md Sojib Khan{" "}
        ...
        <div className="flex space-x-4">
          <img       src={"https://cdn.icon-icons.com/icons2/93/PNG/256/man_user_client_16776.png"}
            alt="User"
            className="w-12 h-12 rounded-full border border-gray-200"
          />
          <div>
      ...
      <div className="mt-8 lg:block hidden">
        <h3 className="text-lg font-semibold text-gray-100">Post a Comment</h3>
        ...
        <div className="p-2 w-1/2">
          <div className="relative">
            ...
            <input
              ...
              id="name"
              name="name"
              className="w-full bg-mylitpink/25  rounded border border-white focus:border-myverydarkpink  text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
            />
          </div>
        </div>
        <div className="p-2 w-1/2">
