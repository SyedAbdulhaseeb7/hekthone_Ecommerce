...
const page = () => {
  return (
    <div className='mb-[100px] bg-white'>
   
      
      <section
        className="bg-cover bg-center h-64 flex items-center justify-center"
        style={{ backgroundImage: "url('https://www.shutterstock.com/image-photo/food-concept-flat-lay-fresh-260nw-2133441375.jpg')" }}
      >
...
<div className="flex flex-col md:flex-row px-4 md:px-[150px] justify-between items-start md:items-center mt-12">
  <div className="flex flex-col w-full md:w-1/2 mb-6 md:mb-0">
    ...
    <div className="border px-4 py-6 text-gray-100 rounded-md w-full md:w-[450px]">
  ...
  <div className="w-full md:w-1/2">
    ...
    <div className="border rounded-md p-4">
      <div className="flex justify-between mb-2 text-[15.5px] text-black">
      ...
      <div className="flex justify-between font-bold text-[15.5px] text-black">
