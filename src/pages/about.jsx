...
<section
  ...
  style={{ backgroundImage: "url('https://img.freepik.com/premium-photo/various-green-vegetables-arranged-row_1235831-324800.jpg')" }}
>
            ...
            return (
              <div key={items.id} className="flex items-center space-x-4 p-4 rounded-md">
                <div className="flex gap-1">
                  <img src={items.img} alt="menu" width={80} height={79} className="w-[60px] md:w-[70px] lg:w-[80px] h-[60px] md:h-[70px] lg:h-[79px] rounded-[6px]"
                  />
                </div>
                <div>
