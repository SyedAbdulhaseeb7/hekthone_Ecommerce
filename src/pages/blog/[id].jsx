...
import {databloglistindivi} from "../../components/BlogData.js"
...
const page = () => {
  ...
  return (
    ...
    <div className=''>
      ...
      <section
        ...
        style={{ backgroundImage: "url('https://st3.depositphotos.com/4590583/33793/i/450/depositphotos_337939972-stock-photo-dark-cooking-banner-vegetables-spices.jpg')" }}
      >
      ...
      <div className='lg:w-[600px] '>
                <div className='flex flex-col gap-4 justify-center mb-[50px]'>
                   <img src={filterd?.image || "/fallback-image.jpg"} alt='blogs' width={400} height={400} className='lg:w-[600px] lg:h-[450px] w-[300px] h-[250px] object-cover'/>
                    ...
                    <div className='lg:flex  gap-7 mt-[20px] lg:w-[580px] w-[300px]'>
                      <div>
                      <img src={filterd?.img2|| "/fallback-image.jpg"} alt='blogs' width={100} height={100} className='lg:w-[400px] mt-[20px] lg:h-[200px]  w-[300px] h-[250px] object-cover'/>
                      </div>
                      <div className=''>
    ...
    <div className=" sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
      <div className="px-4 w-[280px] flex flex-col text-center items-center">
        ...
        <div className="flex-grow items-center ">
          ...
          <h1 className='flex gap-1 justify-center'><IoIosStar className='text-yellow-500'/><IoIosStar className='text-yellow-500'/><IoIosStar className='text-yellow-500'/><IoIosStar className='text-yellow-500'/><IoIosStar className='text-yellow-500'/> (1 Review)</h1>
  ...
  <div className="flex gap-4 mt-6">
    <img
      src="https://hackathon-figma-silk.vercel.app/_next/image?url=%2Fburger.png&w=96&q=75"
      alt="Burger"
      width={80}
      height={80}
  ...
  <div className="flex gap-4 mt-6">
    <img
      src="https://hackathon-figma-silk.vercel.app/_next/image?url=%2Ffries.png&w=256&q=75"
      alt="Fries"
      width={80}
      height={80}
      className="cursor-pointer rounded-lg"
  ...
  <div className="flex gap-4 mt-6">
    <img
      src="https://hackathon-figma-silk.vercel.app/_next/image?url=%2F3picofcart.png&w=96&q=75"
      alt="Fries"
      width={80}
      height={80}
  ...
  <div className="flex gap-4 mt-6">
    ...
    />
    <img
      src="https://www.shutterstock.com/shutterstock/videos/1046211772/thumb/6.jpg?ip=x480"
      alt="Burger"
      width={80}
      height={80}
      className="cursor-pointer rounded-lg object-cover"
    />
    <img
      src="https://backiee.com/static/wallpapers/560x315/198676.jpg"
      alt="Burger"
      width={80}
      height={80}
      className="cursor-pointer rounded-lg object-cover"
    ...
    />
    <img
      src="https://media.istockphoto.com/id/1347931860/photo/roasting-turkey-for-holiday-dinner.jpg?s=612x612&w=0&k=20&c=DZ1Wrf3yM6zqEhuxGRxF77PmG1f0qaf3SUrOfENwgVg="
      alt="Burger"
      width={80}
      height={80}
      className="cursor-pointer rounded-lg object-cover"
